<head>
    ...
    <style>
    body {
    background-color: #000 !important; /* Atau warna lain sesuai kebutuhan */
  }
</style>
</head>
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-dark rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <p class="text-center mb-0 text-light">Sudah memiliki Akun? <a href="{{ route('admin.login') }}">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
